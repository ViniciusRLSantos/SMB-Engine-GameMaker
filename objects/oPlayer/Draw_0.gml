if (state != player_death) {
	switch(carry) {
		case CARRY.GREENSHELL:
			draw_sprite_ext(sGreenKoopaShell, 0, x+dir*sprite_width/2, y-sprite_height/5, dir, 1, 0, c_white, 1);
		break;
		case CARRY.REDSHELL:
			draw_sprite_ext(sRedKoopaShell, 0, x+dir*sprite_width/2, y-sprite_height/5, dir, 1, 0, c_white, 1);
		break;
	}
